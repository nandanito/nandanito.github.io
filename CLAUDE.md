...
- **Identity is a physicist working across three named fields: machine intelligence, quantum computing, and digital-asset infrastructure** (updated 2026-05-18). Featured/headline copy on the home page, `/research/`, `/now/`, and any "what I do" framing names the three fields explicitly. The physics framing comes first ("physicist by training") because it is the underlying lens; the three fields are the working surface. Active job search runs across all three — frontier AI labs, quantum-AI companies, and senior digital-asset / digital-asset infrastructure roles — so headline copy should not depress any of the three. The tagline `Physics → Software → Quantum` is the visual short form and stays. Note: this supersedes the earlier "blockchain / digital-assets as complementary, never as headline" rule; the Quantputation / QubitHub hold (Site posture below) remains separate and unchanged.
